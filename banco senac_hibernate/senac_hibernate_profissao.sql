...
INSERT INTO `profissao` VALUES (1,'descrição bla, bla','Londres'),(2,'descrição bla, bla','Salvador'),(3,'descrição bla, bla','Nova York'),(4,'dfgdf','Prog'),(5,'bla, bla...','Silvio Abreu');
